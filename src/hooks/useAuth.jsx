...
export function AuthProvider({ children }) {
  ...
  const register = useCallback(async (name, email, password, rollNo, year, department) => {
    const data = await api.post('/auth/register', { name, email, password, rollNo, year, department });
    setUser(data.user);
    return data.user;
  }, []);
